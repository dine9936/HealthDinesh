package com.healthmantra.myapplication.Paytm;
...
public class Paytma {
    ...
    public Paytma(String mId, String channelId, String txnAmount, String website, String callBackUrl, String industryTypeId) {
        this.mId = mId;
